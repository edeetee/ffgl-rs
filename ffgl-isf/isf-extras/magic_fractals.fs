...
const mat3 M = mat3(0.28862355854826727f, 0.6997227302779844f, 0.6535170557707412f, 0.06997493955670424f, 0.6653237235314099f, -0.7432683571499161f, -0.9548821651308448f, 0.26025457467376617f, 0.14306504491456504f);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // level of detail.
    vec3 p = Scale * M * vec3(uv - .5f, 0.0f);
